...
//md is knwn for medium devices
//remember 3 property initial transition and animation
type propType={
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6'>
      ...
      >
        ...
        <h1 className='text-4x1 md:text-5xl font-bold text-green-700'>Snapcart</h1>
    </motion.div>
      <motion.p
      initial={{
        opacity:0,
      ...
      >
        Your one-stop destination for fresh groceries, organic product, and daily essential delivered right to your doorstep. 
      </motion.p>
